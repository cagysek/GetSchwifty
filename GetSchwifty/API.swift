...
public final class CharacterQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID? = nil, name: String? = nil, image: String? = nil, species: String? = nil, status: String? = nil, gender: String? = nil, type: String? = nil, origin: Origin? = nil, location: Location? = nil) {
        self.init(unsafeResultMap: ["__typename": "Character", "id": id, "name": name, "image": image, "species": species, "status": status, "gender": gender, "type": type, "origin": origin.flatMap { (value: Origin) -> ResultMap in value.resultMap }, "location": location.flatMap { (value: Location) -> ResultMap in value.resultMap }])
      }
...
public final class CharacterListByIdsQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query CharacterListByIds($ids: [ID!]!) {
  ...
  public let operationName: String = "CharacterListByIds"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public struct Result: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID? = nil, name: String? = nil, status: String? = nil, image: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Character", "id": id, "name": name, "status": status, "image": image])
        }
